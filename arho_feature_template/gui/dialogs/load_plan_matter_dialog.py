...
class LoadPlanMatterDialog(QDialog, LoadPlanMatterDialogBase):  # type: ignore
    ...
    def __init__(self, parent, connection_names: list[str]):
        ...
        self.model.setHorizontalHeaderLabels([tr("Nimi"), tr("Kaava tyyppi"), tr("Tuottajan kaavatunnus"), tr("Pysyvä kaavatunnus")])
    ...
    def get_plan_matters_from_db(self, selected_connection: str) -> Sequence[str]:
        ...
        try:
            ...
            QMessageBox.critical(self, tr("Virhe"), tr("Kaava-asioiden lataus epäonnistui:") + f" {e}")
            self.clear_table()
