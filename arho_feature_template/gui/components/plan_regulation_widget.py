...
class RegulationWidget(QWidget, FormClass):  # type: ignore
    ...
    def _init_widgets(self):
        # Value input
        if self.default_value:
            self._add_widget(RequiredFieldLabel(tr("Arvo")), self.value_widget_manager.value_widget)
    ...
    def _init_additional_attributes_and_information_btn(self):
        ...
        attributes_and_information_menu.addAction(tr("Aihetunniste")).triggered.connect(self._add_subject_identifier)
        attributes_and_information_menu.addAction(tr("Kaavoitusteema")).triggered.connect(self._add_theme)
        attributes_and_information_menu.addAction(tr("Lisätieto")).setMenu(self._create_additional_information_menu())
    ...
    def _add_additional_info(self, additional_information: AdditionalInformation):
        ...
        self._add_widget(QLabel(tr("Lisätieto:")), ai_widget)
    ...
    def _add_subject_identifier(self, subject: str | None = None):
        ...
        self._add_widget(QLabel(tr("Aihetunniste:")), subject_widget)
    ...
    def _add_theme(self, theme_name: str):
        ...
        self._add_widget(QLabel(tr("Kaavoitusteema:")), theme_widget)
    ...
    def _add_type_of_verbal_regulation(self, type_id: str | None = None):
        ...
        self._add_widget(RequiredFieldLabel(tr("Sanallisen määräyksen laji")), widget)
